...
openssl req -x509 -nodes -days 365 -newkey rsa:2048 -keyout /etc/ssl/fgiulian.42.fr.key -out /etc/ssl/fgiulian.42.fr.crt -subj "/C=IT/L=Rome/O=42Roma/OU=student/CN=fgiulian.42.fr"
